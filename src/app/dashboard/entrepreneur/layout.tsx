...
const navItems = [
  { href: "/dashboard/entrepreneur", label: "Overview", icon: LayoutDashboard },
  { href: "/dashboard/entrepreneur/projects", label: "My Projects", icon: Briefcase },
  { href: "/dashboard/entrepreneur/investors", label: "Investors", icon: Users },
  { href: "/dashboard/entrepreneur/messages", label: "Messages", icon: MessageSquare },
  { href: "/dashboard/entrepreneur/analytics", label: "Analytics", icon: BarChart3 },
]
    ...
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      >
        ...
        <nav className="flex-1 space-y-1 p-4 pt-6">
          {navItems.map((item) => {
            const isActive =
              item.href === "/dashboard/entrepreneur"
                ? pathname === item.href
